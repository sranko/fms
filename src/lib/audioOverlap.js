...
function setMusicVolume(volume, key) {
    ...
    //Else, they've entered a wrong parameter type
        ...
        console.log(
            "You've entered a(n): " +
                typeOf +
                ' as the volume parameter. setMusicVolume() only accepts numbers for the volume parameter.'
        ); //Print to console the user error
    }
...
function setSFXVolume(volume, key) {
    ...
    //Else, they've entered a wrong parameter type
        ...
        console.log(
            "You've entered a(n): " +
                typeOf +
                ' as the volume parameter. setSFXVolume() only accepts numbers for the volume parameter.'
        ); //Print to console the user error
    }
